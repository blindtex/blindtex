...
_lr_productions = [
  ...
  ('start -> content','start',1,'p_start','parser.py',58),
  ('start -> start content','start',2,'p_start','parser.py',59),
  ('sblock -> BEGINSBLOCK content ENDSBLOCK','sblock',3,'p_sblock','parser.py',66),
  ('block -> BEGINBLOCK content ENDBLOCK','block',3,'p_block','parser.py',70),
  ('content -> chars','content',1,'p_content','parser.py',74),
  ('content -> block','content',1,'p_content','parser.py',75),
  ('content -> scripted','content',1,'p_content','parser.py',76),
  ('content -> command','content',1,'p_content','parser.py',77),
  ('content -> content content','content',2,'p_content','parser.py',78),
  ('chars -> CHAR','chars',1,'p_chars','parser.py',85),
  ('chars -> ord','chars',1,'p_chars','parser.py',86),
  ('chars -> chars chars','chars',2,'p_chars','parser.py',87),
  ('ord -> ORD','ord',1,'p_ord','parser.py',94),
  ('command -> frac','command',1,'p_command','parser.py',99),
  ('command -> root','command',1,'p_command','parser.py',100),
  ('command -> binop','command',1,'p_command','parser.py',101),
  ('command -> binrel','command',1,'p_command','parser.py',102),
  ('command -> not','command',1,'p_command','parser.py',103),
  ('scripted -> content SUP content','scripted',3,'p_scripted','parser.py',112),
  ('scripted -> content SUB content','scripted',3,'p_scripted','parser.py',113),
  ('frac -> FRAC content content','frac',3,'p_frac','parser.py',120),
  ('root -> ROOT content','root',2,'p_root','parser.py',124),
  ('root -> ROOT sblock content','root',3,'p_root','parser.py',125),
  ('binop -> BINOP','binop',1,'p_binOp','parser.py',132),
  ('binop -> KBINOP','binop',1,'p_binOp','parser.py',133),
  ('binrel -> BINREL','binrel',1,'p_binRel','parser.py',137),
  ('binrel -> KBINREL','binrel',1,'p_binRel','parser.py',138),
  ('not -> NOT','not',1,'p_not','parser.py',142),
]
