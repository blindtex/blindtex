...
_lr_productions = [
  ...
  ('content -> content content','content',2,'p_content','PyParser.py',78),
  ('chars -> CHAR','chars',1,'p_chars','PyParser.py',85),
  ('chars -> ord','chars',1,'p_chars','PyParser.py',86),
  ('chars -> chars chars','chars',2,'p_chars','PyParser.py',87),
  ('ord -> ORD','ord',1,'p_ord','PyParser.py',94),
  ('command -> frac','command',1,'p_command','PyParser.py',99),
  ('command -> root','command',1,'p_command','PyParser.py',100),
  ('command -> binop','command',1,'p_command','PyParser.py',101),
  ('command -> binrel','command',1,'p_command','PyParser.py',102),
  ('command -> not','command',1,'p_command','PyParser.py',103),
  ('scripted -> content SUP content','scripted',3,'p_scripted','PyParser.py',112),
  ('scripted -> content SUB content','scripted',3,'p_scripted','PyParser.py',113),
  ('frac -> FRAC content content','frac',3,'p_frac','PyParser.py',120),
  ('root -> ROOT content','root',2,'p_root','PyParser.py',124),
  ('root -> ROOT sblock content','root',3,'p_root','PyParser.py',125),
  ('binop -> BINOP','binop',1,'p_binOp','PyParser.py',132),
  ('binop -> KBINOP','binop',1,'p_binOp','PyParser.py',133),
  ('binrel -> BINREL','binrel',1,'p_binRel','PyParser.py',137),
  ('binrel -> KBINREL','binrel',1,'p_binRel','PyParser.py',138),
  ('not -> NOT','not',1,'p_not','PyParser.py',142),
]
