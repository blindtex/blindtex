...
_lr_productions = [
  ...
  ('start -> content','start',1,'p_start','PyParser.py',56),
  ('start -> start content','start',2,'p_start','PyParser.py',57),
  ('sblock -> BEGINSBLOCK content ENDSBLOCK','sblock',3,'p_sblock','PyParser.py',64),
  ('block -> BEGINBLOCK content ENDBLOCK','block',3,'p_block','PyParser.py',68),
  ('content -> chars','content',1,'p_content','PyParser.py',72),
  ('content -> block','content',1,'p_content','PyParser.py',73),
  ('content -> scripted','content',1,'p_content','PyParser.py',74),
  ('content -> command','content',1,'p_content','PyParser.py',75),
  ('chars -> CHAR','chars',1,'p_chars','PyParser.py',79),
  ('chars -> ord','chars',1,'p_chars','PyParser.py',80),
  ('chars -> chars chars','chars',2,'p_chars','PyParser.py',81),
  ('ord -> ORD','ord',1,'p_ord','PyParser.py',88),
  ('command -> frac','command',1,'p_command','PyParser.py',93),
  ('command -> root','command',1,'p_command','PyParser.py',94),
  ('command -> binop','command',1,'p_command','PyParser.py',95),
  ('scripted -> content SUP content','scripted',3,'p_scripted','PyParser.py',104),
  ('scripted -> content SUB content','scripted',3,'p_scripted','PyParser.py',105),
  ('frac -> FRAC content content','frac',3,'p_frac','PyParser.py',112),
  ('root -> ROOT content','root',2,'p_root','PyParser.py',116),
  ('root -> ROOT sblock content','root',3,'p_root','PyParser.py',117),
  ('binop -> BINOP','binop',1,'p_binOp','PyParser.py',124),
  ('binop -> KBINOP','binop',1,'p_binOp','PyParser.py',125),
]
