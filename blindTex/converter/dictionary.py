...
class dictionary(object):
    ...
    def addCommand(self, key,
                   value):  # Agregar el comando y la lectura Puede variar cuando las configuraciones estén listas.
        str(value)
        str(key)
    ...
    def showReading(self, key,
                    conf):  # Retorna la lectura configurada, falta implementar para lectura de más de una configuración
